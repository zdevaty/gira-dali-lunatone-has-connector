...
// detectors that need cross-event state (bursts, blinks). The decoder raised a
// `dali_reset` alert of its own until 16 Sep 2026; that frame is TERMINATE and
// is now logged as a command.
